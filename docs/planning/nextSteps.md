...
| 10. Packaging | Not started | Final-test remains sealed; PRNU-v2 and texture are resolved and rejected | Ready to start Task 10 |
...
| Task 10 packaging | Ready to start | Selected output is controlled RINE alone; Task 9 texture is rejected | Documentation/demo preparation only | inference CLI, calibration, release tests |
